...
# 올드 보이 리뷰 데이터 파일을 불러온다
with open('result-2-2-4-old_boy.txt', 'r', encoding = 'utf-8') as f:			# 읽기 모드('r')로 지정하고 인코딩은 'utf-8'로 설정한다
...
# 올드 보이와 위플래시 간의 cosine similarity 계산
print("Similarity between 'Old boy' and 'Whiplash': ", cosine_similarity(X[0], X[1]))
