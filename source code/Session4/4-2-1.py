...
# 올드보이 리뷰 데이터 파일을 불러온다
with open('result-2-2-4-old_boy.txt', 'r', encoding= 'utf-8') as f:
...
print("Similarity between 'Inception' and 'Old boy': ", cosine_similarity(X[0], X[2]))
print("Similarity between 'Whiplash' and 'Old boy': ", cosine_similarity(X[1], X[2]))
